...
?>
<li <?php wc_product_class( 'product-card bg-white rounded-xl border border-gray-200 p-4 flex flex-col justify-between h-full relative shadow-sm hover:shadow-md transition', $product ); ?>>
    ...
    <div class="product-card-image-box w-full aspect-[4/3] rounded-lg overflow-hidden bg-gray-50 flex items-center justify-center mb-3 relative">
    ...
    <!-- Content (Grid: Below Image, List: Middle) -->
    ...
    <div class="product-card-actions space-y-2 mt-auto">
        <?php 
